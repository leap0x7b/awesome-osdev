...
* 😀 https://sortix.org[Sortix] - Sortix is a small self-hosting
operating-system aiming to be a clean and modern POSIX implementation.
...
* 😀 https://github.com/byteduck/duckOS[duckOS] - A hobby UNIX-like
OS with a graphical window manager for x86 computers.
...
* 🙂 https://github.com/MandelbrotOS/MandelbrotOS[MandelbrotOS] - A
community driven OS by the youth
...
basic shell.
* https://greenteapress.com/thinkos[Think OS] - A 2015 book written
as an introduction to operating systems for programmers, written by
Allen B. Downey.
...
* http://0xax.gitbooks.io/linux-insides/content/index.html[Linux Insides]
...
* http://www.oldlinux.org/download/ECLK-5.0.1-WithCover.pdf[A
Heavily Commented Linux Kernel Source Code] [PDF]
